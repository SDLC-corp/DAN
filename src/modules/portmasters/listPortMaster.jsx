...
function ListPortMaster() {
            ...
            try {
                if (result.isConfirmed) {
                    ...
                    if (response.status === 200) {
                        ...
                        getPortMasterList(fromDate, toDate,search)
                    }
                    else {
                        Swal.fire({
                            title: "Error!",
    ...
    const getPortMasterList = async (fromDate, toDate,search) => {
        try {
            setLoading(true);
            let response;
    ...
    useDebounce(() => { getPortMasterList(fromDate, toDate,search) }, 300, dependecies);
