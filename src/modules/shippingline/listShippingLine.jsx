...
function ShippingLineList() {
  ...
  const sections = [
    ...
    { key: 'Document Types List', content: 'Document Types List', active: true },
  ];


  const getAllShippingLine = async (fromDate,toDate) => {
    try {
      setLoading(true);
      let response;
      ...
      selector: (row) =>
        <div >
          {row.logo 
            ...
            : <i className="ship icon" style={{ width: "30px", height: "15px", borderRadius: "50%" }}></i>}  
        </div>,
      width: '10%'
    },
    {
          ...
          <div className="page-header">
            ...
            <div className="page-header-actions">
                <Input
                  ...
                  icon='search'
                  placeholder="Search Shipping Line Name "
                  type="text"
                  onChange={(e, { value }) => {
