        ...
        <div className="page-body">
            <Form style={{ width: '100%' }}>
                ...
                <Form.Field
                    ...
                    onChange={(e, data) => {
                        setDocObj({...docObj, domainName: data.value });
                    }}
                />
                <Form.Field
                ...
                <div className="ui action input" style={{ marginBottom: 18, display: 'flex' }}>
                    ...
                    <Button loading={docNoLoading} disabled={
                        !docObj.documentNo
                        || loading
                        || docNoLoading
                    } content='Check' secondary onClick={onCheckClickHandler} />
                </div>

                <Form.Dropdown
                    label={`${docObj.shippingType === "air" ? "Air":"Shipping"} Lines`}
                ...
                <Form.Dropdown
                    ...
                    options={docObj.shippingType == "air" ? airDocumentType : oceanDocumentType}
                    required={true}
                    error={errorObj && errorObj.fieldId}
                    selection
                    onFocus={() => {
                    ...
                    onChange={(e, data) => {
                        setDocObj({ ...docObj,documentType: data.value });
                    }}
                />
