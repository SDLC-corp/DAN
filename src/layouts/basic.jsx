...
import LogoImg from '../assets/images/patang.png';
import LogoImgWITHCOMAPNYNAME from '../assets/images/Patang_instasync_white.png';
...
function Layout() {
  ...
  const roleSelection = () => {
    ...
    if (authContext.user.role == "superAdmin") {
      ...
      let roleName = authContext.user.roleName 
      ...
      <div className="sidebar-wrapper">
        <Sidebar backgroundColor="#0f182a" width="270px" style={{ maxWidth: '270px', borderWidth: 0 }}>
          <div className="sidebar-header">
            {collapsed ? <Image src={LogoImg} size="mini" centered /> : null} {!collapsed ? <Image src={LogoImgWITHCOMAPNYNAME} size="big" centered /> : null}
          </div>
          <Menu
