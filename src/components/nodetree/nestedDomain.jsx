    ...
    const getDomain = async () => {
        try {
            ...
            if (response.status === 200) {
                ...
                //     let resultData =  getDataAccordingToRole(arr, user.domain[0].split("/")[1])
                //     let allArray = [user.domain[0].split("/")[1]]
                //     for (let i = 1; i < user.domain.length; i++) {
                //         console.log("check",!allArray.includes(user.domain[i].split("/")[1]));
                //         if (!allArray.includes(user.domain[i].split("/")[1])) {
                //              allArray = [...allArray,user.domain[i].split("/")[1]]
                //              const result = getDataAccordingToRole(arr, user.domain[i].split("/")[1])
                //              resultData[0].children[i] = result[0].children[0]
                //         }
                //     }
