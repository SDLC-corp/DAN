...
const AirDocumentUpload = () => {
    ...
    const getListOfShippingLine = async () => {
        try {
        const response = await apiGET(`/v1/shipping-lines?type=${'air'}`);
    ...
    async function verifyDocument(orderBaseXid, domainName) {
        ...
        let response = await apiGET(`/v1/documents/check/orderBases?documentNo=${orderBaseXid}&domainName=${domainName}&type=${'air'}`);
    ...
    const saveBtnClickHandler = async () => {
        ...
        // console.log("saveBtnClickHandler payload ::", payload);
    ...
    return (
        ...
        <div className="eight wide column">
            ...
            <Form.Dropdown
                ...
                options={shippingType == 'ocean' ? oceanDocumentType : airDocumentType}
                required={true}
                error={errorObj && errorObj.fieldId}
                selection
                onFocus={() => {
...
export default AirDocumentUpload;
